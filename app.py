            ...
            message_content = [
                {
                    ...
                    "text": f"I'm sending you 8 frames from a video named '{filename}' with a duration of {int(duration // 60):02d}:{int(duration % 60):02d}. "
                           ...
                           f"Structure your response with proper HTML formatting using <h3>VIDEO SUMMARY</h3> first, followed by a <h3>NARRATED SUMMARY</h3>, and finally the <h3>DETAILED ANALYSIS OF THE VIDEO SEGMENTS</h3>."
                }
            ]
